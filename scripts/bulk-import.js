  ...
  const SCHEMAS = {
    ...
    orders: {
      ...
      cols: [
        ...
        { key: 'goods', label: 'Mặt hàng', aliases: ['mat hang', 'hang hoa', 'hang', 'goods', 'dien giai', 'mo ta', 'noi dung hang'] },
        ...
        { key: 'freight', label: 'Tổng cước (thu khách)', type: 'int', aliases: ['tong cuoc', 'cuoc', 'cuoc van chuyen', 'freight', 'tien cuoc'] },
